...
import { Slide, TextField, Button, Dialog, DialogTitle, Grid, Typography, Box, alpha } from '@mui/material';
...
export default function AddConnectionForm(props) {
      ...
      const [selectedFile, setSelectedFile] = useState('https://source.unsplash.com/random')
      ...
      <form onSubmit={handleSubmit}>
        <Grid sx={{px: 10}} container justify-content="center" align-items="center" justify="center" direction="column">
        <Grid item>
            <label htmlFor="contained-button-file">
                ...
                onMouseLeave={() => {setPictureHover(false)}}>
                    ...
                    <Box display="false" style={{backgroundColor: alpha("#343434", 0.3), position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, justifyContent: 'center', alignItems: 'center', zIndex: 3}}>
                        ...
                        <Typography variant="h10" sx={{justifyContent: 'center', alignItems: 'center', display: 'flex', textTransform: 'none', fontWeight: 'bold', color: 'white'}}>
                            Upload a Picture
                        </Typography>
